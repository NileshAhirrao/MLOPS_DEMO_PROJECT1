...
class ModelTrainer:
    ...
    def get_model_object_and_report(self,train:np.array,test:np.array)->Tuple[object,object]:
        ...
        try:
            ...
            #Initializing RandomForestClassifier with specified parameters
            ...
            metric_artifact=ClassificationMetricArtifact(f1_score=f1,recall_score=recall,precision_score=precision)
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        ...
        try:
            ...
            #Load transformed train and test dataframe

            train_arr=load_numpy_array_data(file_path=self.data_transformation_artifact.transformed_train_file_path)
            test_arr=load_numpy_array_data(file_path=self.data_transformation_artifact.transformed_test_file_path)

            logging.info("Train and Test Transformed data loaded")

            #Get trained model and metrics

            trained_model,metric_artifact=self.get_model_object_and_report(train=train_arr,test=test_arr)

            logging.info("Model Object and Metrics Artifacts loaded")

            #Load Prprocessing Object
